...
class VWidgetsSettingUsersListTile extends StatelessWidget {
  ...
  const VWidgetsSettingUsersListTile({
    super.key,
        ...
        if (showTrailingIcon)
          trailingButtonText != null
              ...
              : IconButton(
                  onPressed: onPressedDelete,
                  icon:
                      trailingIcon ?? const RenderSvg(svgPath: VIcons.remove)),
      ],
    );
  }
}
