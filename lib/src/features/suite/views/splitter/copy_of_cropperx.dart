...
class CropperMine extends StatefulWidget {
  ...
  @override
  State<CropperMine> createState() => _CropperMineState();
...
class _CropperMineState extends State<CropperMine> {
  ...
  @override
  void didUpdateWidget(covariant CropperMine oldWidget) {
