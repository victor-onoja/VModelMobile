...
final categoryServiceSearchProvider =
    StateProvider.autoDispose<String?>((ref) => null);

final categoryServicesProvider = AutoDisposeAsyncNotifierProvider<
    CategoryServicesController,
    List<ServicePackageModel>?>(() => CategoryServicesController());

class CategoryServicesController
  ...
  Future<List<ServicePackageModel>?> build() async {
    ...
    final searchTerm = ref.watch(categoryServiceSearchProvider);
